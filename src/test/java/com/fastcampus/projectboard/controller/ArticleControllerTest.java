...
class ArticleControllerTest {
    ...
    @DisplayName("[view][GET] 게시글 상세 페이지 - 검색어와 함께 호출")
    @Test
    public void givenSearchKeyword_whenSearchingArticleView_thenReturnArticleView()
        throws Exception {
        // Given
    ...
    @Test
    public void givenNothing_whenRequestingArticleSearchHashtagView_thenReturnArticleSearchHashtagView()
        throws Exception {
        // Given
    ...
    @Test
    public void givenHashtag_whenRequestingArticleSearchHashtagView_thenReturnArticleSearchHashtagView()
        throws Exception {
        // Given
        String hashtag = "#java";
        List<String> hashtags = List.of("#java", "#spring", "#boot");
